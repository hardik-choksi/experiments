...
const (
	TelemetryService_ExportSpans_FullMethodName = "/telemetry.v1.TelemetryService/ExportSpans"
)
...
type TelemetryServiceClient interface {
	// Unary RPC: one request → one response (start here, simplest)
	ExportSpans(ctx context.Context, in *ExportSpansRequest, opts ...grpc.CallOption) (*ExportSpansResponse, error)
}
...
func (c *telemetryServiceClient) ExportSpans(ctx context.Context, in *ExportSpansRequest, opts ...grpc.CallOption) (*ExportSpansResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExportSpansResponse)
	err := c.cc.Invoke(ctx, TelemetryService_ExportSpans_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TelemetryServiceServer interface {
	// Unary RPC: one request → one response (start here, simplest)
	ExportSpans(context.Context, *ExportSpansRequest) (*ExportSpansResponse, error)
...
func (UnimplementedTelemetryServiceServer) ExportSpans(context.Context, *ExportSpansRequest) (*ExportSpansResponse, error) {
...
func _TelemetryService_ExportSpans_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExportSpansRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelemetryServiceServer).ExportSpans(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelemetryService_ExportSpans_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).ExportSpans(ctx, req.(*ExportSpansRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TelemetryService_ExportSpans_Handler,
		},
	},
